...
var x = BuildScanExportClient.getFirstEventForBuild(com.kylemoore.json.BuildStarted_1_0, "6ycdlpmt66pyw")
var y = BuildScanExportClient.getFirstEventForBuild(com.kylemoore.json.BuildFinished_1_0, "6ycdlpmt66pyw")
  print(x.timestamp)
  print(y?.timestamp)
